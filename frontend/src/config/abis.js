...
// Mock Contract ABIs (Updated to match actual implementations)
export const MOCK_CCIP_ROUTER_ABI = [
  // CCIP Router functions
  "function ccipSend(uint64 destinationChainSelector, tuple(bytes receiver, bytes data, address feeToken, uint256 gasLimit) message) external payable returns (bytes32)",
  "function getFee(uint64 destinationChainSelector, tuple(bytes receiver, bytes data, address feeToken, uint256 gasLimit) message) external view returns (uint256)",
  "function isChainSupported(uint64 chainSelector) external view returns (bool)",
  "function supportedChains(uint64) external view returns (bool)",
  ...
  // Events
  "event CCIPSendRequested(uint64 indexed destinationChainSelector, address indexed receiver, bytes data, address indexed sender)",
  "event ChainSupportAdded(uint64 indexed chainSelector)",
